...
func ValidateInstallationComponentDescriptorImports(imports []core.ComponentDescriptorImport, fldPath *field.Path, importNames map[string]bool) (field.ErrorList, map[string]bool) {
	allErrs := field.ErrorList{}
